function [ideal_angle,NOM_angle,AVG_angle,LR_angle] = err_dev_run(param,train)
%% parameters %%
%runtime parameters
...
meas_noise = 0.12; % stdv of mesurment device noise
dev_sigma = 0.25; % stdv of deviations for training
dev_max = 0.35; % maximal deviation
curve_sigma = 0.3; % stdv of curve for training
curve_max = 0.7; % maximal curve


%% Untested input %%
%parameters for untesteded array
dev_sigma_test = param; % stdv of deviations for test
curve_test = 0.9*truncnormrnd(1, 0, curve_sigma, -curve_max, curve_max); % curve for test
